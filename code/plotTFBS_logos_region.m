function yAltRelative = plotTFBS_logos_region(tableMutations_candidate, tableMotifs, iRow, isMOTIFG)
...
yAltRelative = plotMotif(tableMotifs.motifMatrix{iMotif}', 10, 2, sequence_ref, [], motifName, positionMutation);
