...
saveFileData = [sProperties.DIRECTORY_SAVE, '/tableMutations_FunSeq2/tableMutations_FunSeq2_',tissueName,'_', biosampleABC, '_', enhancerAnalysis, '_', num2str(minCADD_PHRED), '_', exclusionType, '.mat'];
