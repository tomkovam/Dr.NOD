function plotFigureCCND1(imagesPath, sColours, tableGencodeGenes, tableTissues_data1, dataDepMap, sProperties)
...
for iExample = 1
    if (iExample == 1)
        ...
        tissueName = 'lung'; geneName = 'CCND1';
    elseif (iExample == 2)
...
mySaveAs(fig, imagesPath, 'FigCCND1', true, true);
savefig([imagesPath, 'FigCCND1.fig']);
