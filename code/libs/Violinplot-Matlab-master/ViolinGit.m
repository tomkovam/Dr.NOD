classdef ViolinGit < handle
    % ViolinGit creates violin plots for some data
    ...
    %
    %   See for more information on ViolinGit Plots:
    %   J. L. Hintze and R. D. Nelson, "ViolinGit plots: a box
    %   plot-density trace synergism," The American Statistician, vol.
    %   52, no. 2, pp. 181-184, 1998.
    %
    % ViolinGit Properties:
    ...
    properties (Dependent=true)
        ...
        BoxWidth    % width of box between the quartiles in axis space (default 10% of ViolinGit plot width, 0.03)
    ...
    methods
        function obj = ViolinGit(data, pos, varargin)
            %ViolinGit plots a violin plot of some data at pos
